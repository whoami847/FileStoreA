...
#--------------------------------------------
FSUB_LINK_EXPIRY = int(os.getenv("FSUB_LINK_EXPIRY"))
...
#Time and its price
#7 Days
PRICE1 = os.environ.get("PRICE1")
#1 Month
PRICE2 = os.environ.get("PRICE2")
#3 Month
PRICE3 = os.environ.get("PRICE3")
#6 Month
PRICE4 = os.environ.get("PRICE4")
#1 Year
PRICE5 = os.environ.get("PRICE5")
#===================(END)========================#
