...
async def cb_handler(client: Bot, query: CallbackQuery):
    ...
    if data == "help":
        ...
        try:
            ...
            await query.message.edit_text("ᴀɴ ᴇʀʀᴏʀ ᴏᴄᴄᴜʀʀᴇᴅ ᴡʜɪʟᴇ ʀᴇᴛᴜʀɴɪɴɢ ᴛᴏ ʜᴏᴍᴇ.")
        await query.answer()
        ...
        await client.send_photo(
            ...
            photo=QR_PIC,
            caption=(
                f"👋 {query.from_user.username.lower() if query.from_user.username else 'user'}\n\n"
                f"🎖️ ᴀᴠᴀɪʟᴀʙʟᴇ ᴘʟᴀɴs :\n\n"
                f"● {PRICE1.lower()}  ғᴏʀ 0 ᴅᴀʏs ᴘʀɪᴍᴇ ᴍᴇᴍʙᴇʀsʜɪᴘ\n\n"
                f"● {PRICE2.lower()}  ғᴏʀ 1 ᴍᴏɴᴛʜ ᴘʀɪᴍᴇ ᴍᴇᴍʙᴇʀsʜɪᴘ\n\n"
                f"● {PRICE3.lower()}  ғᴏʀ 3 ᴍᴏɴᴛʜs ᴘʀɪᴍᴇ ᴍᴇᴍʙᴇʀsʜɪᴘ\n\n"
                f"● {PRICE4.lower()}  ғᴏʀ 6 ᴍᴏɴᴛʜs ᴘʀɪᴍᴇ ᴍᴇᴍʙᴇʀsʜɪᴘ\n\n"
                f"● {PRICE5.lower()}  ғᴏʀ 1 ʏᴇᴀʀ ᴘʀɪᴍᴇ ᴍᴇᴍʙᴇʀsʜɪᴘ\n\n\n"
        ...
        try:
            ...
            await query.message.edit_text(
                f"ᴄʜᴀɴɴᴇʟ: {chat.title.lower()}\nᴄᴜʀʀᴇɴᴛ ғᴏʀᴄᴇ-sᴜʙ ᴍᴏᴅᴇ: {status.lower()}",
        ...
        for cid in channels:
            try:
                ...
                buttons.append([InlineKeyboardButton(f"{status} {chat.title.lower()}", callback_data=f"rfs_ch_{cid}")])
            except:
                continue
        await query.message.edit_text(
